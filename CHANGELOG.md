...
## [0.3.4] - 2026-04-12
### Added
- Add new core function `table-str` to return a rendered table directly

### Changed
- Fix several doc typos/inconsistencies
- Bump dependency on Clojure to latest
- Fix :when colspec option
- Prevent zero-width columns during rebalancing
...
[Unreleased]: https://github.com/jgdavey/crockery/compare/v0.3.4...HEAD
[0.3.3]: https://github.com/jgdavey/crockery/compare/v0.3.3...v0.3.4
[0.3.3]: https://github.com/jgdavey/crockery/compare/v0.3.2...v0.3.3
[0.3.2]: https://github.com/jgdavey/crockery/compare/v0.3.1...v0.3.2
